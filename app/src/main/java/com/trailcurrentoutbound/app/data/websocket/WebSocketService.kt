package com.trailcurrentoutbound.app.data.websocket
...
sealed class WebSocketEvent {
    ...
    data class Light(val light: com.trailcurrentoutbound.app.data.model.Light) : WebSocketEvent()
    ...
    data class GnssDetails(val details: com.trailcurrentoutbound.app.data.model.GnssDetails) : WebSocketEvent()
    ...
    private fun parseAndEmitMessage(text: String) {
        try {
            ...
            val event: WebSocketEvent? = when (type) {
                ...
                "light" -> {
                    val light = gson.fromJson(data, com.trailcurrentoutbound.app.data.model.Light::class.java)
                ...
                "gnss_details" -> {
                    val details = gson.fromJson(data, com.trailcurrentoutbound.app.data.model.GnssDetails::class.java)
